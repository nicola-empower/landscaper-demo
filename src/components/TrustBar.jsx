...
const defaultItems = [
    { title: "RHS Gold Medalist", subtitle: "Award Winning", icon: Award, colorClass: "text-amber-500" },
    { title: "Marshalls Register", subtitle: "Accredited Installer", icon: ShieldCheck, colorClass: "text-blue-600" },
    { title: "20+ Years", subtitle: "Experience", icon: CheckCircle, colorClass: "text-green-600" }
];
