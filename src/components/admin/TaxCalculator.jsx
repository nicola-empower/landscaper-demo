    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-gray-800 p-4 rounded-xl space-y-4">
                <h3 className="text-lg font-bold text-[#15803D] mb-2">Your Figures</h3>
                <div>
                    ...
                    <input
                        ...
                        className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-[#15803D] focus:border-[#15803D]"
                    />
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                    <input
                        ...
                        className="h-5 w-5 rounded bg-gray-700 border-gray-600 text-[#15803D] focus:ring-[#15803D]"
                    />
            ...
            <div className="bg-gray-800 p-4 rounded-xl">
                <h3 className="text-lg font-bold text-[#15803D] mb-4">Estimated Take-Home</h3>

                <div className="mb-4 p-4 bg-gray-700/50 rounded-xl border border-[#15803D]/30 text-center">
                    <span className="text-xs font-medium text-[#15803D]">Annual Net Income</span>
